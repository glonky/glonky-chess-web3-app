...
export const ConnectWalletButton = () => {
  ...
  const buttonClassName =
    'md:group max-w-xs md:w-full flex items-center md:block rounded-md md:px-3.5 md:py-2 text-sm md:text-left font-medium text-white bg-indigo-800 md:hover:bg-indigo-600 md:hover:bg-opacity-75 focus:outline-none focus:ring-2 ring-offset-2 ring-indigo-500 ring-offset-white ring-offset-opacity-60';

  if (!account) {
    return (
      <button
        onClick={() => activateBrowserWallet()}
        className={classNames(buttonClassName, 'py-2 px-3 md:p-0')}
  ...
  return (
    <Menu.Button className={buttonClassName} data-testid="connect-wallet-account-id-button">
